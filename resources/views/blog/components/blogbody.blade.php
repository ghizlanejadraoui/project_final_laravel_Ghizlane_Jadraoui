{{-- section 1 --}}
<section class="blsc1 w-full h-full p-3 ">
...
{{-- section 2 --}}
<section class="blsc2 w-full h-full p-5 ">
    <div class="d-flex w-full flex-row flex-column-reverse flex-lg-row justify-content-evenly align-items-center  ">
        ...
        <div class="w-full d-flex flex-column gap-3 justify-content-center align-items-center ">
            ...
            <h4 class="w-50 text-center">
                Ghizlane restaurant and bar are located in the heart of Hells Kitchen,
                on the corner of 10th Avenue & 52nd Street. If you have questions, suggestions or comments, please get a
                hold of us in whichever way that is most convenient.
            </h4>
            <div class="d-flex justify-content-evenly w-full gap-5  ">
                <div class="d-flex flex-column align-items-center gap-3">
                    ...
                    <h5 class="text-center">Tel: 212 265 2755</h5>
                </div>
                <div class="d-flex flex-column align-items-center gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                    ...
                    <h5 class="text-center">contact@ghizlanerestaurant.com</h5>
                </div>
                <div class="d-flex flex-column align-items-center gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                    ...
                    <h5 class="text-center">764 10th Ave, New York, NY 10019</h5>
                </div>
